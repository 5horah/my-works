const ProductViewer = function() {
    ...
    const initialize = ()=>{
        const viewers = Array.from(document.querySelectorAll("[data-product-viewer]")).map((element)=>new Viewer360(element));
        const tabs = Array.from(document.querySelectorAll("[data-tab-container]")).map((element)=>new TabComponent(element));
...
//# sourceMappingURL=index.7fc7a333.js.map
